...
ALLOWED_HOSTS = ['istp-app.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'istp_core.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = os.getenv(key='EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = os.getenv(key='EMAIL_HOST_PASSWORD')